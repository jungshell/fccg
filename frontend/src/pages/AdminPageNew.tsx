  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        const unifiedResponse = await fetch(`${API_ENDPOINTS.BASE_URL}/unified-vote-data`, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
    ...
    try {
      ...
      */
      ...
      try {
        ...
        // 모든 게임 조회
        const allGamesResponse = await fetch(`${API_ENDPOINTS.BASE_URL}/games`, {
          headers: {
        ...
        if (allGamesResponse.ok) {
          ...
          for (const game of autoGeneratedGames) {
            try {
              const deleteResponse = await fetch(`${API_ENDPOINTS.BASE_URL}/games/${game.id}`, {
                method: 'DELETE',
                headers: {
                  'Authorization': `Bearer ${token}`
                }
