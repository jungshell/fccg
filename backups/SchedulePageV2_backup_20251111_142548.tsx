  ...
  */
  ...
  const renderThisWeekSchedule = () => (
    <Box
      ...
      flex="1"
    >
      <Flex align="center" gap={{ base: 0.6, md: 1 }} mb={{ base: 0.35, md: 0.6 }} mt={0}>
        <Box as="span" fontSize={{ base: "md", md: "lg" }}>⚽</Box>
        <Text fontSize={{ base: "md", md: "lg" }} fontWeight="bold">이번주 일정</Text>
      </Flex>
      
      <VStack spacing={0} align="stretch" mb={0}>
        {updateThisWeekScheduleWithGames.map((schedule) => {
          const actualCount = schedule.count;
          const isConfirmed = schedule.confirmed;
          
          return (
          <Flex key={schedule.date} justify="space-between" align="center" py={{ base: '2px', md: '4px' }} px={0} lineHeight={1}>
              <Flex align="center" gap={{ base: 0.6, md: 1 }} flex="1" minW="0">
                <Text 
          ...
          <Box w={{ base: '100%', lg: '400px' }} p={{ base: 2, md: 4 }} pr={{ base: 2, md: 4, lg: 6 }} overflowX="hidden" boxSizing="border-box">
            <VStack spacing={{ base: 1, md: 1.5 }} align="stretch">
              ...
              <Box
                ...
                borderColor="gray.200"
              >
                <Flex justify="space-between" align="center" mb={{ base: 0.35, md: 0.6 }} mt={0}>
                  <Flex align="center" gap={{ base: 1, md: 1.5 }}>
                        ...
                        {getScheduleData.nextWeekVoteData.map((vote, index) => {
                          ...
                          return (
                            <Flex
                              ...
                              _active={{ transform: isHoliday ? 'none' : 'translateY(0px)', boxShadow: 'none' }}
                              _focus={{ outline: isHoliday ? 'none' : '2px solid', outlineColor: 'purple.400', outlineOffset: '2px' }}
                            ...
                            >
                              <Flex align="center" gap={{ base: 0.6, md: 1 }} flex="1" minW="0">
                                <Text fontSize={{ base: 'xs', md: 'sm' }} fontWeight={isMaxVote ? 'bold' : (isHoliday ? 'semibold' : 'normal')} noOfLines={1} lineHeight={1} color={isHoliday ? 'red.500' : 'gray.700'}>
                                  {vote.date}
                                </Text>
                                {isMaxVote && (
                                  <Badge
